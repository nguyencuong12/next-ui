      ...
      <FoodContent>
        {products &&
          products.map((instance) => {
            return <CardComponent title={instance.title!} description={instance.description!} image={instance.image!.toString()} price={instance.price!} chips={"Food"} id={instance._id!} _id={instance._id!}></CardComponent>;
          })}
      </FoodContent>
